...
// Trek creation form initial state
...
function CompanyItinerariesScreen() {
  ...
  const [activeTab, setActiveTab] = useState('myTreks') // 'myTreks' or 'createTrek'
  ...
  // Form step state (multi-step form)
  const [formStep, setFormStep] = useState(1)

  // Map state for route creation
